...
;
carousel.style.left = '1vw'; // Variables Of The Elements
...
;
const arrowEffect = elementsWidth + 1; // width of elements * num of elements + gap between the cards - (watched space - 2 of the border)
